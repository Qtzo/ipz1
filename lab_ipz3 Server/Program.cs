...
namespace Server_IPZ
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            SqlConnection cnn;
            connetionString = (@"Data Source=DESKTOP-GGEHTCU\SQLEXPRESS;Initial Catalog=ipz;Integrated Security=True;Pooling=False"); 
            ...
            void SearchUser()
            {
                ...
                string sqlExpression = "select count(Login) from Users where Login = '" + log + "'";
                string sqlExpression1 = "select count(Pass) from Users where Pass = '" + pass + "'";
            ...
            void Info()
            {
                ...
                while (reader.Read())
                {
                    k += "\n" + "|" + reader.GetValue(0).ToString() + " " + reader.GetValue(1).ToString() + " " + reader.GetValue(2).ToString() + " " + reader.GetValue(3).ToString() + " " + reader.GetValue(4).ToString();
                    p = 1;
